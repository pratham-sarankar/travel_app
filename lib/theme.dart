...
class MaterialTheme {
  ...
  static MaterialScheme lightScheme() {
    return const MaterialScheme(
      ...
      tertiaryFixed: Color(0xfffdd7fb),
      onTertiaryFixed: Color(0xff2a132c),
      tertiaryFixedDim: Color(0xffdfbbde),
      onTertiaryFixedVariant: Color(0xff593e5a),
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      ...
      tertiaryFixedDim: Color(0xff6f5270),
  ...
  static MaterialScheme lightHighContrastScheme() {
    return const MaterialScheme(
      ...
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff3d243f),
      onTertiaryFixedVariant: Color(0xffffffff),
      surfaceDim: Color(0xffdad9e0),
      surfaceBright: Color(0xfffaf8ff),
      surfaceContainerLowest: Color(0xffffffff),
  ...
  static MaterialScheme darkMediumContrastScheme() {
    return const MaterialScheme(
      ...
      tertiary: Color(0xffe4c0e2),
      onTertiary: Color(0xff240d27),
      tertiaryContainer: Color(0xffa786a7),
      ...
      tertiaryFixedDim: Color(0xffdfbbde),
      onTertiaryFixedVariant: Color(0xff472d49),
      surfaceDim: Color(0xff121318),
      surfaceBright: Color(0xff38393e),
      surfaceContainerLowest: Color(0xff0c0e13),
      surfaceContainerLow: Color(0xff1a1b20),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      tertiaryContainer: Color(0xffe4c0e2),
      onTertiaryContainer: Color(0xff000000),
      ...
      inversePrimary: Color(0xff0a2859),
      ...
      tertiaryFixedDim: Color(0xffe4c0e2),
